...
@TargetApi(11)
public class BaseGPUImageRenderer implements Renderer, PreviewCallback {
    ...
    public BaseGPUImageRenderer(final GPUImageFilter filter) {
        mFilter = filter;
        ...
        runOnDraw(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    camera.setPreviewCallback(BaseGPUImageRenderer.this);
                    camera.startPreview();
                } catch (IOException e) {
                    e.printStackTrace();
                }
