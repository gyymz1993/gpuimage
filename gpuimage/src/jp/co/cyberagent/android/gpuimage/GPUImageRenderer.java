...
public class GPUImageRenderer implements Renderer, PreviewCallback {
    ...
    public GPUImageRenderer(final GPUImageFilter filter) {
        ...
        Log.e("TAG", "init---------->>>> init  GPUImageRenderer");
        mFilter = filter;
    ...
    public void onSurfaceCreated(final GL10 unused, final EGLConfig config) {
        ...
        Log.e("GPUImageRenderer",   ": mSurfaceTexture " + mSurfaceTexture);
    ...
    public void onSurfaceChanged(final GL10 gl, final int width, final int height) {
        ...
        Log.e("GPUImageRenderer",   ": onSurfaceChanged " + mSurfaceTexture);
        Log.e("GPUImageRenderer",   ": onSurfaceChanged " + mediaPlayer);
    ...
    public void setSourceSize(int imageWidth, int imageHeight) {
        ...
        Log.e("GPUImageRenderer", "mImageWidth  :" + mImageWidth + ": mImageHeight " + mImageHeight);
    }
